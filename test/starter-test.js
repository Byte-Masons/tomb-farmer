...
describe('Vaults', function () {
  ...
  const wantHolderAddr = '0x46bb3c9fe50e28cd619a2a1a3914338ea8ef64b9';
  ...
  beforeEach(async function () {
    ...
    strategy = await hre.upgrades.deployProxy(
      Strategy,
      [vault.address, [treasuryAddr, paymentSplitterAddress], [strategistAddr], wantAddress, 10],
      { kind: 'uups' },
    );
  ...
  describe('Vault Tests', function () {
    it('should allow deposits and account for them correctly', async function () {
      ...
      const depositAmount = toWantUnit('0.000099');
    ...
    it('should mint user their pool share', async function () {
      ...
      const ownerDepositAmount = toWantUnit('0.0000001');
    ...
    it('should be able to harvest', async function () {
      await vault.connect(wantHolder).deposit(toWantUnit('0.000099'));
  ...
  describe('Strategy', function () {
    ...
    it('should be able to estimate harvest', async function () {
      const whaleDepositAmount = toWantUnit('0.000099');
