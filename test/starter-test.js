...
describe('Vaults', function () {
  ...
  const wantHolderAddr = '0xa08a0a97b6a871f2d97c66c0035120b54fb594b5';
  ...
  beforeEach(async function () {
    ...
    Strategy = await ethers.getContractFactory('ReaperStrategyTombUsdcUnderlying');
    ...
    strategy = await hre.upgrades.deployProxy(
      Strategy,
      [vault.address, [treasuryAddr, paymentSplitterAddress], [strategistAddr], wantAddress, 9],
      { kind: 'uups' },
    );
  ...
  describe('Vault Tests', function () {
    it('should allow deposits and account for them correctly', async function () {
      ...
      const depositAmount = toWantUnit('0.000000000003');
    ...
    it('should mint user their pool share', async function () {
      const userBalance = await want.balanceOf(wantHolderAddr);
      const depositAmount = toWantUnit('0.000000000002');
      await vault.connect(wantHolder).deposit(depositAmount);

      const ownerDepositAmount = toWantUnit('0.0000000000003');
    ...
    it('should be able to harvest', async function () {
      await vault.connect(wantHolder).deposit(toWantUnit('0.000000000003'));
  ...
  describe('Strategy', function () {
    ...
    it('should be able to estimate harvest', async function () {
      const whaleDepositAmount = toWantUnit('0.000000000003');
