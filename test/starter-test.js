...
describe('Vaults', function () {
  ...
  beforeEach(async function () {
    ...
    Strategy = await ethers.getContractFactory('ReaperStrategyTombFtmTshare');
    ...
    strategy = await hre.upgrades.deployProxy(
      Strategy,
      [vault.address, [treasuryAddr, paymentSplitterAddress], [strategistAddr], wantAddress, 5],
      { kind: 'uups' },
    );
  ...
  describe('Vault Tests', function () {
    ...
    it('should be able to harvest', async function () {
      await vault.connect(wantHolder).deposit(toWantUnit('1'));
  ...
  describe('Strategy', function () {
    ...
    it('should be able to estimate harvest', async function () {
      const whaleDepositAmount = toWantUnit('2');
