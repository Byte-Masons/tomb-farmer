 ...
 */
contract ReaperStrategyTombWftmUnderlyingV3 is ReaperBaseStrategyv2 {
    ...
    function estimateHarvest() external view override returns (uint256 profit, uint256 callFeeToUser) {
        ...
        if (totalRewards != 0) {
            uint256 fromTombRouter = IUniswapV2Router02(TOMB_ROUTER).getAmountsOut(totalRewards, lshareToWftmPath)[1];
            uint256 fromSpookyRouter = IUniswapV2Router02(SPOOKY_ROUTER).getAmountsOut(totalRewards, lshareToWftmPath)[
                1
            ];
